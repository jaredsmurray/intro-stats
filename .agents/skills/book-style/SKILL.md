...
Keep an explicit analytical question when it creates an obligation that the section later answers. A short question, or a pair of linked questions, can state the problem that the next model, calculation, or evidence resolves. Do not classify that question-answer structure as telegraphing. Require the later prose to answer the question; cut a rhetorical question that merely announces the topic.
