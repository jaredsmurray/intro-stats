...
### An ordinal example: rating the economy

Sorting by size was the right call for `purpose`, whose categories have no inherent order. Ordinal variables call for the opposite. Each fall the Federal Reserve's Survey of Household Economics and Decisionmaking asks a national sample to rate economic conditions in this country today, and the answer falls into four ordered categories --- "poor," "only fair," "good," or "excellent." @fig-shed-outlook plots the 2025 responses in that natural order.
...
The tallest bar is "only fair," but we leave it second from the left where it belongs. The categories are ordered, so their sequence is part of the message: reading left to right traces the ratings from grim to glowing. Sorting by height would throw that away --- and it would do real damage here. Fewer than 2% of households answered "excellent." Sorted by size, that sliver would sit beside "good" as just another short bar; in its natural position at the end of the scale, it says something on its own: almost nobody thinks conditions are excellent.
